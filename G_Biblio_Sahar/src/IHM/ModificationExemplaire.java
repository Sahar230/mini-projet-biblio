...
public class ModificationExemplaire extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        modifierBouton.setBackground(new Color(133, 202, 205));
        annulerBouton = new javax.swing.JButton();
        annulerBouton.setForeground(new Color(255, 255, 255));
        annulerBouton.setBackground(new Color(133, 202, 205));

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Modification Exemplaire");

        jPanel1.setBackground(new Color(153, 210, 209));
        ...
        panAjoutBas.setBackground(new Color(133, 202, 205));
        panAjoutBas.setBorder(javax.swing.BorderFactory.createTitledBorder(""));

        etatExemplaireLabel.setFont(new Font("Century Gothic", Font.BOLD, 14)); // NOI18N
