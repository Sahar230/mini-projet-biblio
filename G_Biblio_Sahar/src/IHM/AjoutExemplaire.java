...
public class AjoutExemplaire extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ajouterBouton.setBackground(new Color(81, 175, 181));
        annulerBouton = new javax.swing.JButton();
        annulerBouton.setBackground(new Color(81, 175, 181));

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Ajouter Exemplaire");

        jPanel1.setBackground(new Color(81, 175, 181));
        ...
        panAjoutBas.setBackground(new Color(81, 175, 181));
        panAjoutBas.setBorder(javax.swing.BorderFactory.createTitledBorder(""));

        etatExemplaireLabel.setFont(new Font("Century Gothic", Font.BOLD, 20)); // NOI18N
        ...
        identifiantLabel.setText("ID-Exemplaire");
