...
public class GestionReservationsEmprunts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rendreButton.setForeground(new Color(64, 128, 128));
        emprunterButton = new javax.swing.JButton();
        emprunterButton.setEnabled(false);
        emprunterButton.setBackground(new Color(255, 255, 255));
        emprunterButton.setForeground(new Color(64, 128, 128));
        affEmpButton = new javax.swing.JButton();
        affEmpButton.setForeground(new Color(64, 128, 128));
        affEmpButton.setEnabled(false);
        affEmpButton.setBackground(new Color(255, 255, 255));
        affExempButton = new javax.swing.JButton();
        affExempButton.setForeground(new Color(64, 128, 128));
        ...
        empruntsButton.setForeground(new Color(64, 128, 128));
        empruntsButton.setBackground(new Color(255, 255, 255));
        ReservationButton = new javax.swing.JButton();
        ReservationButton.setForeground(new Color(130, 189, 189));
        retourButton = new javax.swing.JButton();
        retourButton.setForeground(new Color(130, 189, 189));
        retourButton.setBackground(new Color(255, 255, 255));
        ...
        jPanel2.setBackground(new Color(133, 203, 189));

        mainPanel.setBackground(new java.awt.Color(255, 255, 255));
        mainPanel.setLayout(new java.awt.CardLayout());

        EmpruntPanel.setBackground(new Color(133, 203, 189));

        panEmpCours.setBackground(new Color(133, 203, 189));
        ...
        menuEmpPanel.setBackground(new Color(133, 203, 189));
        ...
        panExemplaires.setBackground(new Color(133, 203, 189));
        ...
        jPanel1.setBackground(new Color(133, 203, 189));
        ...
        titleResaEmpLabel.setFont(new Font("Century Gothic", Font.BOLD, 36)); // NOI18N
        titleResaEmpLabel.setForeground(new Color(255, 255, 255));
        titleResaEmpLabel.setText("Gestion des Réservations et Emprunts");

        jPanel3.setBackground(new Color(133, 203, 189));
        ...
        identifiantComboBox.setModel(new DefaultComboBoxModel(new String[] {"ID-Livre"}));
