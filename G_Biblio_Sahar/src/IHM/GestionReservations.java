...
public class GestionReservations extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        validerBouton.setBackground(new Color(90, 180, 180));
        annulerBouton = new javax.swing.JButton();
        annulerBouton.setForeground(new Color(255, 255, 255));
        annulerBouton.setBackground(new Color(90, 180, 180));
        nomUsagerLabel = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Réserver");

        jPanel1.setBackground(new Color(85, 183, 183));
        ...
        panAjoutBas.setBackground(new Color(85, 183, 183));
        panAjoutBas.setBorder(javax.swing.BorderFactory.createTitledBorder(""));

        nomLabel.setFont(new Font("Century Gothic", Font.BOLD, 18)); // NOI18N
        nomLabel.setForeground(new Color(255, 255, 255));
        nomLabel.setText("Nom utilisateur");
        ...
        identifiantUsagerCombo.setModel(new DefaultComboBoxModel(new String[] {"ID"}));
        		...
        		.addGroup(Alignment.LEADING, jPanel1Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addGap(77)
        					.addComponent(titleLabel, GroupLayout.PREFERRED_SIZE, 277, GroupLayout.PREFERRED_SIZE))
