...
public class GestionEmprunts extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        identifiantUsagerCombo.setBackground(new Color(192, 192, 192));
        identifiantUsagerCombo.setForeground(new Color(255, 255, 128));
        identifiantUsagerCombo.setModel(new DefaultComboBoxModel(new String[] {"selectioner"}));
        validerBouton = new javax.swing.JButton();
        validerBouton.setForeground(new Color(255, 255, 255));
        validerBouton.setBackground(new Color(92, 180, 180));
        annulerBouton = new javax.swing.JButton();
        annulerBouton.setBackground(new Color(92, 180, 180));
        ...
        jPanel1.setBackground(new Color(80, 166, 173));
        ...
        titleLabel.setText("Utilisateur");

        panAjoutBas.setBackground(new Color(80, 166, 173));
        ...
        identifiantLabel.setText("ID-utilisateur");

        identifiantUsagerCombo.setFont(new java.awt.Font("Times New Roman", 1, 12));
